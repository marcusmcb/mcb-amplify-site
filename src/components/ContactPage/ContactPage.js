        ...
        <Row className='g-0'>
          <Card className='contact-card-body'>
            <Card.Body className='contact-card-text-background'>
              ...
              <div className='contact-card-text contact-item'>
                <a
                  href='https://docs.google.com/document/d/1HCi-wo3nl6cZliPU_vokSjvGshk__QlFkWCCVxXtsNA/edit?usp=share_link'
                  target='_blank'
                  rel='noreferrer'
                  className='contact-row'
                >
              ...
              <div className='contact-card-text contact-item'>
                <a
                  href='https://drive.google.com/file/d/1wsTS6038V-qAEAhmIhU1LMZ20O0mL4a7/view?usp=sharing'
                  target='_blank'
                  rel='noreferrer'
                  className='contact-row'
                >
